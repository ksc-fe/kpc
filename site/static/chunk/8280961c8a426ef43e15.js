...
exports.default = function (obj, _Vdt, blocks, $callee) {
  ...
  return h('div', null, h(_table2.default, { 'scheme': function () {
    ...
    }.call(this), 'noDataTmplate': function () {
      try {
        return [tip][0];
      } catch (e) {
        _e(e);
