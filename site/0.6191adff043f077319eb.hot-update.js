                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 5;
                                return fs.readFile(global.root + this.get('path') + 'index.json', 'utf-8');
