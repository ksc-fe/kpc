...
var Header = (_dec = Intact.template(), (_class = (_temp = _class2 = /*#__PURE__*/function (_Intact) {
  _inheritsLoose(Header, _Intact);
  ...
  _proto._updateClassNames = function _updateClassNames() {
    this.set('_className', {
      'k-header': true,
  ...
  _proto._detectAside = function _detectAside() {};
