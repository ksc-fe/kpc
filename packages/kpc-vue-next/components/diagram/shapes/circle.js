...
export var DCircle = /*#__PURE__*/function (_DShape) {
  _inheritsLoose(DCircle, _DShape);

  var _super = _createSuper(DCircle);

  function DCircle() {
    return _DShape.apply(this, arguments) || this;
  }

  var _proto = DCircle.prototype;
...
_defineProperty(DCircle, "displayName", 'DCircle');