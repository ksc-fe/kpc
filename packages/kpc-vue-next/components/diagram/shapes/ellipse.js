...
export var DEllipse = /*#__PURE__*/function (_DShape) {
  _inheritsLoose(DEllipse, _DShape);

  var _super = _createSuper(DEllipse);

  function DEllipse() {
    return _DShape.apply(this, arguments) || this;
  }

  var _proto = DEllipse.prototype;
...
_defineProperty(DEllipse, "displayName", 'DEllipse');