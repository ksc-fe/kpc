...
export default class Demo extends React.Component {
    ...
    render() {
        return (
            <Collapse value={this.state.value} on$change-value={(c, value) => this.setState({value})} accordion arrow="left">
                <CollapseItem
                    b-title={<React.Fragment>设计语言<a className="link" href="/docs/design/language/">详细说明</a></React.Fragment>}
                >
