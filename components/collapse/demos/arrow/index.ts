...
@Component({
    selector: 'app-demo',
    template: `
        <k-collapse [(value)]="value" [accordion]="true" arrow="left">
            <k-collapse-item>
                <ng-template #title>设计语言<a class="link" href="/docs/design/language/">详细说明</a></ng-template>
