...
| loading | 开关loading属性 | `boolean` | `false` | 3.3.3 |
| beforeChange | 切换`Switch`之前的拦截函数，如果该函数返回`false`则阻止本次切换，支持异步函数, 参数为当前值from，期望切换值to | <code>(from: any, to: any) => boolean &#124; Promise&lt;boolean&gt;</code> | `undefined` | 3.3.3 |
