...
```
"<div class=\"k-header\"><span class=\"k-title\"></span></div><div class=\"k-body\"><div class=\"k-tip-icon\"><i class=\"k-icon ion-ios-checkmark\"></i></div>test</div><div class=\"k-footer c-clearfix\"><button class=\"k-btn k-primary k-ok\" tabindex=\"0\" type=\"button\"><span>确定</span></button></div>"
```
