...
```
"<div><div class=\"k-badge\">Message<sup class=\"k-text\"></sup></div><div class=\"k-badge\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button><sup class=\"k-text\"></sup></div></div>"
```

####   `Badge disabled`

```
"<div><div class=\"k-badge\">Message</div><div class=\"k-badge\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button></div><div class=\"k-badge k-has-text\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button></div><div class=\"k-badge k-has-text\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button></div></div>"
```

####   `Badge text`

```
"<div><div class=\"k-badge k-has-text\">Message<sup class=\"k-text\">new</sup></div><div class=\"k-badge k-has-text\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button><sup class=\"k-text\">19</sup></div><div class=\"k-badge k-has-text\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Message</button><sup class=\"k-text\">99+</sup></div></div>"
```
...
```
"<div><button class=\"k-btn\" tabindex=\"0\" type=\"button\">default</button><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">primay</button><button class=\"k-btn k-warning\" tabindex=\"0\" type=\"button\">warning</button><button class=\"k-btn k-danger\" tabindex=\"0\" type=\"button\">danger</button><button class=\"k-btn k-success\" tabindex=\"0\" type=\"button\">success</button><button class=\"k-btn k-none\" tabindex=\"0\" type=\"button\">none</button></div>"
```

####   `Button disabled`

```
"<div><button class=\"k-btn k-disabled\" tabindex=\"-1\" type=\"button\">disabled</button><button class=\"k-btn k-none k-disabled\" tabindex=\"-1\" type=\"button\">disabled text</button><button class=\"k-btn k-btn-icon k-circle k-disabled\" tabindex=\"-1\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button></div>"
```

####   `Button group`

```
"<div><div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">开机</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">关机</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">重启</button></div><div class=\"k-btns\"><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">开机</button><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">关机</button><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">重启</button></div><div class=\"k-btns\"><button class=\"k-btn k-primary k-icon-left\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-arrow-left\"></i><!-- react-mount-point-unstable --><span>上一页</span></button><button class=\"k-btn k-primary k-icon-right\" tabindex=\"0\" type=\"button\"><span>下一页</span><i class=\"k-icon ion-ios-arrow-right\"></i><!-- react-mount-point-unstable --></button></div><br><br><p>纵向按钮组</p><div class=\"k-btns k-vertical\"><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">开机</button><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">关机</button><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">重启</button></div><br><br><p>radio按钮组</p><div class=\"k-btns\"><button class=\"k-btn k-active\" tabindex=\"0\" type=\"button\">北京<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">上海<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">广州<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">深圳<input type=\"radio\" tabindex=\"-1\"></button></div><p>checkbox按钮组</p><div class=\"k-btns\"><button class=\"k-btn k-small\" tabindex=\"0\" type=\"button\">北京<input type=\"checkbox\" tabindex=\"-1\"></button><button class=\"k-btn k-small\" tabindex=\"0\" type=\"button\">上海<input type=\"checkbox\" tabindex=\"-1\"></button><button class=\"k-btn k-small\" tabindex=\"0\" type=\"button\">广州<input type=\"checkbox\" tabindex=\"-1\"></button><button class=\"k-btn k-small\" tabindex=\"0\" type=\"button\">深圳<input type=\"checkbox\" tabindex=\"-1\"></button></div></div>"
```

####   `Button icon`

```
"<div><button class=\"k-btn k-btn-icon\" tabindex=\"0\" type=\"button\"><i class=\"ion-ios-search\"></i><!-- react-mount-point-unstable --></button><button class=\"k-btn k-btn-icon k-circle\" tabindex=\"0\" type=\"button\"><i class=\"ion-ios-search\"></i><!-- react-mount-point-unstable --></button><button class=\"k-btn k-primary k-icon-left\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --><span>搜索</span></button><button class=\"k-btn k-primary k-circle k-icon-left\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --><span>搜索</span></button></div>"
```

####   `Button loading`

```
"<div><button class=\"k-btn k-primary k-loading k-disabled\" tabindex=\"-1\" type=\"button\"><i class=\"k-icon ion-load-c icon-loading\"></i>确认</button><button class=\"k-btn k-btn-icon k-circle k-loading k-disabled\" tabindex=\"-1\" type=\"button\"><i class=\"k-icon ion-load-c icon-loading\"></i><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button><br> <br><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">点击加载</button><button class=\"k-btn k-primary k-icon-left\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><span>点击加载</span></button><button class=\"k-btn k-btn-icon k-circle\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i></button><button class=\"k-btn k-primary k-icon-right\" tabindex=\"0\" type=\"button\"><span>图标在右侧</span><i class=\"k-icon ion-ios-search\"></i></button></div>"
```

####   `Button size`

```
"<div><button class=\"k-btn k-large\" tabindex=\"0\" type=\"button\">large</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">default</button><button class=\"k-btn k-small\" tabindex=\"0\" type=\"button\">small</button><button class=\"k-btn k-mini\" tabindex=\"0\" type=\"button\">mini</button><br><br><button class=\"k-btn k-btn-icon k-large k-circle\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button><button class=\"k-btn k-btn-icon k-circle\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button><button class=\"k-btn k-btn-icon k-small k-circle\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button><button class=\"k-btn k-btn-icon k-mini k-circle\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-search\"></i><!-- react-mount-point-unstable --></button></div>"
```

####   `Button tagName`

```
"<div><div class=\"k-btn k-primary\" tabindex=\"0\">div元素按钮</div><div class=\"k-btn k-disabled\" tabindex=\"-1\">disabled div button</div><a class=\"k-btn\" href=\"https://www.ksyun.com\" target=\"_blank\" tabindex=\"0\">超链接按钮</a></div>"
```
...
```
"<div><div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">从上侧出现</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">从下侧出现</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">从左侧出现</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">从右侧出现</button></div><!--placeholder--></div>"
```
...
```
"<div><div class=\"k-dropdown\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">More &gt;</button><!--placeholder--></div></div>"
```
...
```
"<div><div class=\"k-dropdown\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">DropdownItem with Tooltip</button><!--placeholder--></div></div>"
```
...
```
"<div><div class=\"k-switch k-default\" tabindex=\"0\" style=\"width: 60px;\"><input type=\"checkbox\" tabindex=\"-1\"><div class=\"k-off\" style=\"width: 60px;\">展开</div><div class=\"k-bar\"><div class=\"k-on\" style=\"width: 60px;\">收起</div><div class=\"k-wrapper\"><div class=\"k-handle\"><img src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"></div></div></div></div><div class=\"k-switch k-default\" tabindex=\"0\" style=\"width: 60px;\"><input type=\"checkbox\" tabindex=\"-1\"><div class=\"k-off\" style=\"width: 60px;\">dark</div><div class=\"k-bar\"><div class=\"k-on\" style=\"width: 60px;\">light</div><div class=\"k-wrapper\"><div class=\"k-handle\"><img src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"></div></div></div></div><div class=\"k-switch k-default\" tabindex=\"0\" style=\"width: 100px;\"><input type=\"checkbox\" tabindex=\"-1\"><div class=\"k-off\" style=\"width: 100px;\">vertical</div><div class=\"k-bar\"><div class=\"k-on\" style=\"width: 100px;\">horizontal</div><div class=\"k-wrapper\"><div class=\"k-handle\"><img src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"></div></div></div></div><div class=\"k-btns\"><button class=\"k-btn k-active\" tabindex=\"0\" type=\"button\">large<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">default<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">small<input type=\"radio\" tabindex=\"-1\"></button></div><br><br><div class=\"k-menu k-large\"><div class=\"k-header\"><i class=\"k-icon ion-star\"></i><span>Header</span></div><div class=\"k-menu-item\"><div class=\"k-title\"><i class=\"k-icon ion-flag\"></i><span>menu 1</span></div></div><div class=\"k-menu-item k-disabled\"><div class=\"k-title\"><i class=\"k-icon k-dot ion-record\"></i><span>menu 2</span></div></div><div class=\"k-menu-item k-expanded\"><div class=\"k-title\"><i class=\"k-icon ion-heart\"></i><span>menu 3</span><i class=\"k-arrow ion-ios-arrow-down\"></i></div><div class=\"k-show-height\"><div class=\"k-menu k-vertical\"><div class=\"k-menu-item\"><div class=\"k-title\"><span>sub menu 1</span></div></div><div class=\"k-menu-item\"><div class=\"k-title\"><span>sub menu 2</span></div></div><div class=\"k-menu-item k-disabled\"><div class=\"k-title\"><span>sub menu 3</span></div></div><div class=\"k-menu-item\"><div class=\"k-title\"><span>sub menu 4</span><i class=\"k-arrow ion-ios-arrow-down\"></i></div><div class=\"k-show-height\" style=\"height: 0px; display: none;\"><div class=\"k-menu k-vertical\"><div class=\"k-menu-item\"><div class=\"k-title\"><span>option 1</span></div></div><div class=\"k-menu-item\"><div class=\"k-title\"><span>option 2</span></div></div></div></div></div></div></div></div><div class=\"k-menu-item\"><div class=\"k-title\"><i class=\"k-icon ion-gear-b\"></i><span>menu 4</span></div></div></div></div>"
```
...
```
"<div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">info</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">error</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">warning</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">success</button></div>"
```

####   `Message custom`

```
"<div><button class=\"k-btn\" tabindex=\"0\" type=\"button\">custom message</button><!--message--></div>"
```

####   `Message duration`

```
"<div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">close after 10s</button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">stick message</button></div>"
```
...
```
"<div><div class=\"k-btns\"><button class=\"k-btn k-active\" tabindex=\"0\" type=\"button\">large<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">default<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">small<input type=\"radio\" tabindex=\"-1\"></button><button class=\"k-btn\" tabindex=\"0\" type=\"button\">mini<input type=\"radio\" tabindex=\"-1\"></button></div><br><br><button class=\"k-btn\" tabindex=\"0\" type=\"button\">新增Tab</button><div class=\"k-tabs k-large\"><div class=\"k-scroll c-clearfix\"><div class=\"k-wrapper\" style=\"transform: translateX(0px);\"><div class=\"k-tab k-active\">Tab 1<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 2<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 3<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-active-bar\" style=\"left: 10px; width: 120px;\"></div></div></div></div><div class=\"k-tabs k-large k-card\"><div class=\"k-scroll c-clearfix\"><div class=\"k-wrapper\" style=\"transform: translateX(0px);\"><div class=\"k-tab k-active\">Tab 1<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 2<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 3<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div></div></div></div><div class=\"k-tabs k-large k-border-card\"><div class=\"k-scroll c-clearfix\"><div class=\"k-wrapper\" style=\"transform: translateX(0px);\"><div class=\"k-tab k-active\">Tab 1<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 2<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 3<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div></div></div></div><div class=\"k-tabs k-large k-card k-no-border-card\"><div class=\"k-scroll c-clearfix\"><div class=\"k-wrapper\" style=\"transform: translateX(0px);\"><div class=\"k-tab k-active\">Tab 1<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 2<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div><div class=\"k-tab\">Tab 3<button class=\"k-btn k-none k-btn-icon k-mini k-close\" tabindex=\"0\" type=\"button\"><i class=\"k-icon ion-ios-close-empty\"></i></button></div></div></div></div></div>"
```
...
```
"<div><div class=\"k-tooltip\" confirm=\"true\" trigger=\"click\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">删除</button><!--placeholder--></div></div>"
```

####   `Tooltip content`

```
"<div><div class=\"k-tooltip\" trigger=\"click\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">Adjust Volume</button><!--placeholder--></div></div>"
```

####   `Tooltip position`

```
"<div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">left</button><!--placeholder--><button class=\"k-btn\" tabindex=\"0\" type=\"button\">right</button><!--placeholder--><button class=\"k-btn\" tabindex=\"0\" type=\"button\">top</button><!--placeholder--><button class=\"k-btn\" tabindex=\"0\" type=\"button\">bottom</button><!--placeholder--></div>"
```

####   `Tooltip trigger`

```
"<div class=\"k-btns\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">hover</button><!--placeholder--><button class=\"k-btn\" tabindex=\"0\" type=\"button\">click</button><!--placeholder--><button class=\"k-btn\" tabindex=\"0\" type=\"button\">can hover</button><!--placeholder--></div>"
```
...
```
"<div class=\"wrapper\"><div class=\"c-clearfix\"><div class=\"k-btns\"><button class=\"k-btn k-btn-icon k-small\" tabindex=\"0\" type=\"button\">+</button></div></div><div class=\"k-tree\"><div class=\"k-node\"><div class=\"k-label\"><i class=\"k-icon ion-android-arrow-dropdown\"></i><label class=\"k-checkbox\" tabindex=\"0\"><span class=\"k-wrapper\"><input type=\"checkbox\" tabindex=\"-1\" value=\"true\"></span></label><span class=\"k-text\">First floor-1</span><!-- react-mount-point-unstable --><div class=\"k-btns\"><button class=\"k-btn k-btn-icon k-small\" tabindex=\"0\" type=\"button\">+</button><button class=\"k-btn k-btn-icon k-small\" tabindex=\"0\" type=\"button\">-</button></div></div></div><div class=\"k-node\"><div class=\"k-label\"><i class=\"k-icon ion-android-arrow-dropdown\"></i><label class=\"k-checkbox\" tabindex=\"0\"><span class=\"k-wrapper\"><input type=\"checkbox\" tabindex=\"-1\" value=\"true\"></span></label><span class=\"k-text\">First floor-2</span><!-- react-mount-point-unstable --><div class=\"k-btns\"><button class=\"k-btn k-btn-icon k-small\" tabindex=\"0\" type=\"button\">+</button><button class=\"k-btn k-btn-icon k-small\" tabindex=\"0\" type=\"button\">-</button></div></div></div></div></div>"
```
...
```
"<div class=\"k-upload\"><input class=\"c-hidden\" type=\"file\" multiple=\"\"><div class=\"k-handle\"><button class=\"k-btn k-primary\" tabindex=\"0\" type=\"button\">选择文件</button></div><div class=\"k-tip\"><button class=\"k-btn\" tabindex=\"0\" type=\"button\">开始上传</button></div><div class=\"k-files\"></div><!--placeholder--></div>"
```
