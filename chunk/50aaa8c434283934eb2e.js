...
var _Intact$Vdt$utils = _intact.default.Vdt.utils,
...
(0, _defineProperty2.default)(Checkbox, "propTypes", {
  ...
  trueValue: undefined,
  falseValue: undefined // set value to falseValue when destroy
...
function _default(obj, _Vdt, blocks, $callee) {
  ...
  var _self$get = self.get(),
      ...
      rest = (0, _objectWithoutPropertiesLoose2.default)(_self$get, ["className", "disabled", "falseValue", "children", "value", "trueValue", "style", "ref", "key", "indeterminate", "title"]);
...
exports.FORMATS = exports.yearArray = exports.monthArray = void 0;

var _construct2 = _interopRequireDefault(__webpack_require__("@babel/runtime-corejs2/helpers/construct"));
...
function dispatchEvent(target, eventName, options) {
  ...
  (0, _assign.default)(event, options);
...
function createDate(date) {
  if (typeof date === 'string') {
    ...
    return (0, _construct2.default)(Date, args);
  }
...
var monthArray = (0, _utils.range)(0, 11).map(function (i) {
  return {
    label: (0, _utils._$)(i + 1 + "\u6708"),
    value: i
  };
});
exports.monthArray = monthArray;

var yearArray = function yearArray(value) {
...
var isEmptyString = function isEmptyString(vNode) {
  ...
  if (type === 'object') return (0, _utils.isTextVNode)(vNode) && vNode.children.trim() === '';
  return false;
};
...
function Wrapper(props, flag) {
  var children = props.children,
      ...
      key = props.key,
      ref = props.ref,
      rest = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "position", "key", "ref"]); // const [element, menu] = children;
  // ignore whitespaces
  ...
  var useWrapper = flag === 'angular' || flag && _utils.config.useWrapper;
...
function (_Intact) {
  ...
  _proto._documentClickHandler = function _documentClickHandler(e) {
    e._handler && e._handler.forEach(function (fn) {
      return fn();
    });
  };
  ...
  _proto._destroy = function _destroy() {
    ...
    clearTimeout(this.timer); // clear _mousedown flag

    clearTimeout(this._mousedownTimer);
    this._mousedown = false;
    document.removeEventListener('mouseup', this._onMouseUp); // clearTimeout(this.documentTimer);
...
function (_Intact) {
  ...
  return Input;
}(_intact.default), (0, _defineProperty2.default)(_class2, "template", _index.default), (0, _defineProperty2.default)(_class2, "blocks", ['prepend', 'append', 'prefix', 'suffix']), (0, _defineProperty2.default)(_class2, "propTypes", {
  type: String,
  name: String,
  value: [String, Number],
...
function _default(obj, _Vdt, blocks, $callee) {
  ...
  var events = ['keydown', 'keyup', 'change', 'keypress'].reduce(function (memo, name) {
    ...
    try {
      ...
      return blocks.prepend ? (children = blocks.prepend.call(this, function () {}), h('div', null, function () {
        ...
        try {
          return {
            "k-prepend": true,
            "k-padding": (0, _utils.isTextBlock)(children)
          };
        } catch (e) {
          _e(e);
        }
...
function _default(obj, _Vdt, blocks, $callee) {
  ...
  var _self$get = self.get(),
      ...
      key = _self$get.key,
      title = _self$get.title,
      rest = (0, _objectWithoutPropertiesLoose2.default)(_self$get, ["className", "disabled", "trueValue", "style", "children", "value", "ref", "key", "title"]);
...
function (_Intact) {
  ...
  return OptionGroup;
}(_intact.default), (0, _defineProperty2.default)(_class2, "template", _group.default), (0, _defineProperty2.default)(_class2, "blocks", ['label']), (0, _defineProperty2.default)(_class2, "propTypes", {
...
var _utils2 = __webpack_require__("./components/datepicker/utils.js");
...
function (_Intact) {
  ...
  _proto._onHide = function _onHide() {
    (0, _utils2.dispatchEvent)(this.element, 'focusout');
  };
  ...
  keypress: true,
  keydown: true
}), (0, _defineProperty2.default)(_class2, "blocks", ['format']), _temp), ((0, _applyDecoratedDescriptor2.default)(_class, "template", [_dec], (_init = (0, _getOwnPropertyDescriptor.default)(_class, "template"), _init = _init ? _init.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
  ...
  return h('div', (0, _assign.default)({}, function () {
    ...
    'children': [h('div', {
      ...
      'children': [h('input', {
        ...
        var args = arguments;
        return blocks['value'] ? blocks['value'].apply($this, [function () {
          return _blocks['value'].apply($this, args);
        }].concat(__slice.call(args, 1))) : _blocks['value'].apply($this, args);
      }) && __blocks['value'].apply($this, [__noop].concat(function () {
        try {
...
function (_Intact) {
  ...
  /*#__PURE__*/
  function () {
    var _changeTab2 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
...
module.exports = "//damife.ks3-cn-beijing.ksyun.com/kpc/fonts/page1.png";
...
module.exports = "//damife.ks3-cn-beijing.ksyun.com/kpc/fonts/page2.png";
...
function _default(obj, _Vdt, blocks, $callee) {
  ...
  return h('div', null, [h('div', null, h('header', null, (_blocks['header'] = function (parent) {
    return [h('div', null, [h(_link.default, {
      ...
      'target': '_blank'
    }, '定制主题'), h('div', null, null, 'border')]), h('div', null, null, 'line'), function () {
      try {
        return null;
      } catch (e) {
        _e(e);
