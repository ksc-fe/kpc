...
function (_Intact) {
  ...
  _proto._mount = function _mount() {
    ...
    var triggerElement = this.element.previousSibling; // maybe it is used as contextmenu

    if (!triggerElement) return; // in react, it may be a comment which value is ' react-mount-point-unstable ' 

    if (triggerElement.nodeType === 8 && triggerElement.nodeValue === ' react-mount-point-unstable ') {
...
function _default(obj, _Vdt, blocks, $callee) {
  ...
  var classNameObj = (_classNameObj = {
    'k-select': true
  }, _classNameObj[className] = className, _classNameObj[scope.className] = scope.className, _classNameObj['k-disabled'] = disabled, _classNameObj['k-show'] = _show, _classNameObj['k-clearable'] = clearable, _classNameObj["k-" + size] = size !== 'default', _classNameObj['k-fluid'] = fluid, _classNameObj['k-with-prefix'] = blocks.prefix, _classNameObj['k-with-suffix'] = !hideIcon || loading, _classNameObj['k-inline'] = inline, _classNameObj);
  ...
  return h('div', (0, _assign.default)({}, function () {
    ...
    'children': [h('div', {
      ...
      try {
        return !hideIcon || clearable || loading;
      } catch (e) {
        _e(e);
      }
    }.call($this) ? h('span', null, [function () {
